...
GRID_CONFIG = {
    'max_bin': np.linspace(50, 1550, num=7).astype(int),           # ***  [200 ---> 15000]
    'num_iterations': np.linspace(250, 2000, num=8).astype(int),    # ***  [100 ---> 1000]
    'learning_rate': np.concatenate((np.logspace(-4, -1, num=4), [0.5])),                    # ***  [0.1  ---> 0.0001]
