...
python3 /n/home04/aboesky/berger/Weird_Galaxies/V2_host_prop_grid_search/run_agent.py $AGENT_I $BATCH_SIZE "$NODES_PER_LAYER" $NUM_LINEAR_OUTPUT_LAYERS $LEARNING_RATE