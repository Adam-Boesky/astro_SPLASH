    ...
    if not SKIP_TRAINING:
        ...
        for epoch in range(n_epochs):
            ...
            if test_loss < best_loss:
                best_loss = test_loss
                best_epoch = epoch
                checkpoint(model, "/Users/adamboesky/Research/ay98/Weird_Galaxies/powlaw_n8_weighted_host_prop_best_model.pkl")
        ...
        plot_training_loss(losses_per_epoch['train'], test_losses=losses_per_epoch['test'], filename='/Users/adamboesky/Research/ay98/Weird_Galaxies/V2_host_prop_nn_training_plots/final_loss_v_epoch.png')

    # Load best model
    resume(model, '/Users/adamboesky/Research/ay98/Weird_Galaxies/powlaw_n8_weighted_host_prop_best_model.pkl')
