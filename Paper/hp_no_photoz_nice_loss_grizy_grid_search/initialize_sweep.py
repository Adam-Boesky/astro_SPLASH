...
def tune_parameters():
    ...
    if os.path.exists('/n/home04/aboesky/berger/Weird_Galaxies/hp_no_photoz_nice_loss_grizy_grid_search/results') and os.path.isdir('/n/home04/aboesky/berger/Weird_Galaxies/hp_no_photoz_nice_loss_grizy_grid_search/results'):
        shutil.rmtree('/n/home04/aboesky/berger/Weird_Galaxies/hp_no_photoz_nice_loss_grizy_grid_search/results')
    os.mkdir('/n/home04/aboesky/berger/Weird_Galaxies/hp_no_photoz_nice_loss_grizy_grid_search/results')
