...
def tune_parameters():
    ...
    if os.path.exists('/n/home04/aboesky/berger/Weird_Galaxies/hp_abs_mag_grid_search/results') and os.path.isdir('/n/home04/aboesky/berger/Weird_Galaxies/hp_abs_mag_grid_search/results'):
        shutil.rmtree('/n/home04/aboesky/berger/Weird_Galaxies/hp_abs_mag_grid_search/results')
    os.mkdir('/n/home04/aboesky/berger/Weird_Galaxies/hp_abs_mag_grid_search/results')
